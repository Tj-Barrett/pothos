...
void verho(file_info *file_info,
...
// verho_processing
void verho_processing(string filename,
                string outFile,
                file_info *file_info,
                int k, int verbose){
  ...
  while(std::getline(infile,line)){
    ...
    // last line triggers writing header line and data
      ...
      // verho
      verho(file_info, &step_info, &atom_avs, k, verbose);
      // write data
...
//                                                                            //
//============================================================================//
int verho_compute(string inFile,
                 string outFile,
                 int k,
                 int verbose) {
  ...
  verho_processing(inFile, outFile, &file_info, k, verbose);
